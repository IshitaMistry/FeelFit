...
// companion object is used to define singleton object
    //The singleton pattern is used to ensure that only one instance
// of a class is created in the entire execution of a program
