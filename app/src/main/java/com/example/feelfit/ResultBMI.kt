...
class ResultBMI : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intbmi < 16 ){
            ...
            binding.contentLayout.setBackgroundColor(R.color.red)
        }
        else if(intbmi < 16.9 && intbmi > 16)
        {
            binding.textUnderWeight.setText("Moderate Skinny")
            binding.contentLayout.setBackgroundColor(R.color.purple_700)


        }
        else if (intbmi < 18.4 && intbmi > 17){
            binding.textUnderWeight.setText("Mild Thinness")
            binding.contentLayout.setBackgroundColor(R.color.grey)
...

        {
            ...
            binding.contentLayout.setBackgroundColor(R.color.green)


        } else if ( intbmi < 29.9 &&  intbmi > 25 ){
            binding.textUnderWeight.setText(" Over weight!!")
            binding.contentLayout.setBackgroundColor(R.color.black)
